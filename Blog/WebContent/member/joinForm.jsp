...
<head>
  ...
  <script language="javascript">
	...
	function goPopup() {
		...
		var pop = window.open("/Blog/popup/jusoPopup.jsp", "pop",
     		...
     		<form name="form" id="form" method="POST" action="<%=request.getContextPath() %>/member?cmd=member_join">
     			<fieldset class="form-group">     			
     				...
     				<div class="form-goup">
     				 ...
     				 <div id="list"></div>
						<div id="callBackDiv">
     				 <input class="form-control form-control-lg" type="text" name="roadFul lAddr" id="roadFullAddr" maxlength="20" required readonly>
     				</div>
     				</div>
     				<div class="form-goup">
